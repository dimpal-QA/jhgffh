...
public class AuditAccessAgentViewNormalFlowScn1_Page extends base {
	public WebDriver driver;

	public AuditAccessAgentViewNormalFlowScn1_Page(WebDriver driver13) {
	...
	By accAndIdApprover=By.xpath("//textarea[@id='customfield_13216']");
	...
	By secondSubtaskLink = By.xpath("(//a[@class='issue-link'])[4]");
	...
	public void AccAndIdApprover(String text) throws Throwable{
		multipleSuggestionsAdding(accAndIdApprover, text);
	}
	...
	public WebElement SecondSubtaskLink() {
		return driver.findElement(secondSubtaskLink);
	}
