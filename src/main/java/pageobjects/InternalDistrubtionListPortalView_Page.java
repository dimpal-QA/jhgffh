...
public class InternalDistrubtionListPortalView_Page extends base{
	public WebDriver driver;
	public InternalDistrubtionListPortalView_Page(WebDriver driver12){
	...
	By emailAddress=By.xpath("//div[@class='field-container']//input[@id='customfield_13330']");
