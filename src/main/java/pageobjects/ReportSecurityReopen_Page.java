...
public class ReportSecurityReopen_Page extends base {
	public WebDriver driver;
	public ReportSecurityReopen_Page(WebDriver driver3) {
		this.driver = driver3;
	}
...
public WebElement AwaitingUserInfo(){
	return driver.findElement(awaitingUserInfo);
}
...
public WebElement ReOpenButton(){
	return driver.findElement(reOpen);
}
