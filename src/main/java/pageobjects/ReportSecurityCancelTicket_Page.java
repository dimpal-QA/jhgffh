...
public class ReportSecurityCancelTicket_Page extends base {
	public WebDriver driver;
	public ReportSecurityCancelTicket_Page(WebDriver driver4) {
		this.driver = driver4;
	}
	...
	By awaitingThirdParty=By.id("action_id_121");
	...
	By cancelIncident=By.id("action_id_481");
...
public WebElement AwaitingThirdParty(){
	return driver.findElement(awaitingThirdParty);
}
...
public WebElement CancelIncident(){
	return driver.findElement(cancelIncident);
}
}
